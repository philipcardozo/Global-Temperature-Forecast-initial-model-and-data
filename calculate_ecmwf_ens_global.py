...
def main() -> None:
    ...
    if not perturbed_files:
        raise FileNotFoundError(
            "No perturbed ECMWF ENS files found."
        )

    if not control_files:
        raise FileNotFoundError(
            "No ECMWF control files found."
        )
